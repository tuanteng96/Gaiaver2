...
import { toAbsoluteUrlSv } from "../../../../_ezs/_helpers/AssetsHelpers";
    ...
    >
      <Modal.Body className="px-30">
        ...
        {defaultValues.type === "LessonBG" && (
          <iframe
            title={toAbsoluteUrlSv(`${defaultValues.link}/story_html5.html`)}
            src={toAbsoluteUrlSv(`${defaultValues.link}/story_html5.html`)}
            frameBorder="0"
            scrolling="auto"
            className="w-100 h-100"
          ></iframe>
